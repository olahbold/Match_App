  ...
  return (
    <View style={styles.StatisticContainer}>
      ...
      <StatisticTable
        ...
        Away={currentStats.YellowCardAway}
        Title={"Yellow Card"}
        HomeWidth={currentStats.YellowcardHome}
        AwayWidth={currentStats.YellowCardAway}
      />
      <StatisticTable
        Home={currentStats.RedCardHome}
        Away={currentStats.RedcardAway}
        Title={"Red Card"}
        HomeWidth={currentStats.RedCardHome}
        AwayWidth={currentStats.RedcardAway}
      />
    </View>
  );
};
